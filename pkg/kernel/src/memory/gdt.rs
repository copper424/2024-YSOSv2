...
lazy_static! {
    static ref TSS: TaskStateSegment = {
        ...
        tss.interrupt_stack_table[DOUBLE_FAULT_IST_INDEX as usize] = {
            ...
            let stack_end = stack_start + STACK_SIZE as u64;
            info!(
                "Double Fault Stack for Interruption : 0x{:016x}-0x{:016x}",
                stack_start.as_u64(),
                stack_end.as_u64()
            );
            stack_end
        ...
        tss.interrupt_stack_table[PAGE_FAULT_IST_INDEX as usize] = {
            ...
            let stack_end = stack_start + STACK_SIZE as u64;
            info!(
                "Page Fault Stack for Interruption : 0x{:016x}-0x{:016x}",
                stack_start.as_u64(),
                stack_end.as_u64()
            );
            stack_end
        ...
        tss.interrupt_stack_table[CLOCK_IST_INDEX as usize] = {
            ...
            let stack_end = stack_start + STACK_SIZE as u64;
            info!(
                "Clock Interruption Stack for Interruption : 0x{:016x}-0x{:016x}",
                stack_start.as_u64(),
                stack_end.as_u64()
            );
            stack_end
        ...
        tss.interrupt_stack_table[SYSCALL_IST_INDEX as usize] = {
            ...
            let stack_end = stack_start + STACK_SIZE as u64;
            info!(
                "System Call Stack for Interruption : 0x{:016x}-0x{:016x}",
                stack_start.as_u64(),
                stack_end.as_u64()
            );
            stack_end
